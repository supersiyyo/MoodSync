...
- **Apple Music API:** Serves as the alternative integration to handle music playback and playlist creation for users opting out of Spotify. It acts as a secondary music catalog to fetch and queue songs.
